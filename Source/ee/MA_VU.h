...
private:
	...
	private:
		...
		static void							ReflOpAffWrItRdFlags(VUShared::VUINSTRUCTION*, CMIPS*, uint32, uint32, VUShared::OPERANDSET&);
		...
		static void							ReflOpAffWrItRdIsFlags(VUShared::VUINSTRUCTION*, CMIPS*, uint32, uint32, VUShared::OPERANDSET&);
		...
		static void							ReflOpAffWrVi1RdFlags(VUShared::VUINSTRUCTION*, CMIPS*, uint32, uint32, VUShared::OPERANDSET&);
