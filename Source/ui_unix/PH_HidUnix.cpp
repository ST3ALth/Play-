...
void CPH_HidUnix::InputValueCallbackPressed(CPH_HidUnix* context, uint32 valueRef)
{
    context->InputValueCallback(valueRef, 1);
}

void CPH_HidUnix::InputValueCallbackReleased(CPH_HidUnix* context, uint32 valueRef)
{
    context->InputValueCallback(valueRef, 0);
}
